// Footer Component
// Generated: 2025-08-29T10:57:54.877Z
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl text-foreground">SingleSection Test</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Revolutionizing modern tech solutions with cutting-edge single-page applications. 
                Join thousands of developers and businesses who trust our innovative platform.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@singlesectiontest.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">123 Tech Hub, Suite 100</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest tech updates and product releases. No spam, unsubscribe anytime.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 SingleSection Test. All rights reserved.</span>
